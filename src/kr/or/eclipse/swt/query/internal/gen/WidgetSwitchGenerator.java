...
public class WidgetSwitchGenerator
{
  ...
  protected final String TEXT_7 = "/*" + NL + " * This file was generated by SWT Query SDK." + NL + " * So you should not modify it manually." + NL + " * If you want to customize this code, contact below:" + NL + " *" + NL + " * http://code.google.com/p/swtquery/" + NL + " */" + NL + "public class WidgetSwitch<T> {";
  protected final String TEXT_8 = NL + "    /**" + NL + "     * do switching for ";
  protected final String TEXT_9 = "." + NL + "     * @param ";
  protected final String TEXT_10 = " ";
  protected final String TEXT_11 = " to switch." + NL + "     * @return switching result." + NL + "     */" + NL + "\tpublic T case";
  ...
  protected final String TEXT_20 = NL + "\tpublic final T doSwitch(Widget widget) {";
  protected final String TEXT_21 = NL + "\t\t";
  protected final String TEXT_22 = "{" + NL + "\t\t\treturn case";
  protected final String TEXT_23 = "((";
  protected final String TEXT_24 = ")widget);" + NL + "\t\t}";
