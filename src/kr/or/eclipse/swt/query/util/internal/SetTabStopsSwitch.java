 ...
 */
public class SetTabStopsSwitch extends WidgetSwitchWithArgument<Object, int[]> {
	public void setProperty(Widget widget, int[] value){
		doSwitch(widget, value);
	}

	public Object caseStyledText(StyledText widget, int[] value){
		widget.setTabStops(value);
		return null;
	}
}
