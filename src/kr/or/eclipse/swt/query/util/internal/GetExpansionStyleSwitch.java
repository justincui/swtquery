 ...
 */
public class GetExpansionStyleSwitch extends WidgetSwitch<Integer> {
	public Integer getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Integer caseExpandableComposite(ExpandableComposite widget){
		return widget.getExpansionStyle();
	}
}
