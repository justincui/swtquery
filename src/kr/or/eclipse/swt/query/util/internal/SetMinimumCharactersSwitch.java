 ...
 */ 
public class SetMinimumCharactersSwitch extends WidgetSwitchWithArgument<Object, Integer> {
	public void setProperty(Widget widget, Integer value){
		doSwitch(widget, value);
	}

	public Object caseCTabFolder(CTabFolder widget, Integer value){
		widget.setMinimumCharacters(value);
		return null;
	}
}
