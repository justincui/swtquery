 ...
 */
public class GetDragListenersSwitch extends WidgetSwitch<DragSourceListener[]> {
	public DragSourceListener[] getProperty(Widget widget){
		return doSwitch(widget);
	}

	public DragSourceListener[] caseDragSource(DragSource widget){
		return widget.getDragListeners();
	}
}
