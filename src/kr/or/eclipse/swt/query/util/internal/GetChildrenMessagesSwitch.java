 ...
 */
public class GetChildrenMessagesSwitch extends WidgetSwitch<IMessage[]> {
	public IMessage[] getProperty(Widget widget){
		return doSwitch(widget);
	}

	public IMessage[] caseForm(Form widget){
		return widget.getChildrenMessages();
	}
}
