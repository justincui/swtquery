 ...
 */
public class GetRowSwitch extends WidgetSwitch<TableItem> {
	public TableItem getProperty(Widget widget){
		return doSwitch(widget);
	}

	public TableItem caseTableCursor(TableCursor widget){
		return widget.getRow();
	}
}
