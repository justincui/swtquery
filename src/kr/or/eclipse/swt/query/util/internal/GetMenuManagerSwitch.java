 ...
 */
public class GetMenuManagerSwitch extends WidgetSwitch<IMenuManager> {
	public IMenuManager getProperty(Widget widget){
		return doSwitch(widget);
	}

	public IMenuManager caseForm(Form widget){
		return widget.getMenuManager();
	}
}
