 ...
 */ 
public class GetMatchEmptyStringSwitch extends WidgetSwitch<Boolean> {
	public Boolean getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Boolean caseFilteredList(FilteredList widget){
		return widget.getMatchEmptyString();
	}
}
