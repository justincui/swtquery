 ...
 */
public class GetMessageTypeSwitch extends WidgetSwitch<Integer> {
	public Integer getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Integer caseScrolledForm(ScrolledForm widget){
		return widget.getMessageType();
	}
	public Integer caseForm(Form widget){
		return widget.getMessageType();
	}
}
