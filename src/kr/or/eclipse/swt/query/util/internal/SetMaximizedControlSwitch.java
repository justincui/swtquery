 ...
 */
public class SetMaximizedControlSwitch extends WidgetSwitchWithArgument<Object, Control> {
	public void setProperty(Widget widget, Control value){
		doSwitch(widget, value);
	}

	public Object caseSashForm(SashForm widget, Control value){
		widget.setMaximizedControl(value);
		return null;
	}
}
