 ...
 */
public class SetMaximizedSwitch extends WidgetSwitchWithArgument<Object, Boolean> {
	...
	public Object caseShell(Shell widget, Boolean value){
		widget.setMaximized(value);
		return null;
	}
	public Object caseDecorations(Decorations widget, Boolean value){
		widget.setMaximized(value);
		return null;
	}
