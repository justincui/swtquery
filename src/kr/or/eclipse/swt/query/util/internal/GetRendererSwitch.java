 ...
 */
public class GetRendererSwitch extends WidgetSwitch<CTabFolderRenderer> {
	public CTabFolderRenderer getProperty(Widget widget){
		return doSwitch(widget);
	}

	public CTabFolderRenderer caseCTabFolder(CTabFolder widget){
