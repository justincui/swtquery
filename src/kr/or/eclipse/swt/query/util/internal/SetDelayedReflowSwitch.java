 ...
 */
public class SetDelayedReflowSwitch extends WidgetSwitchWithArgument<Object, Boolean> {
	public void setProperty(Widget widget, Boolean value){
		doSwitch(widget, value);
	}

	public Object caseSharedScrolledComposite(SharedScrolledComposite widget, Boolean value){
		widget.setDelayedReflow(value);
		return null;
	}
}
