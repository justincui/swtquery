 ...
 */ 
public class SetRightWidthSwitch extends WidgetSwitchWithArgument<Object, Integer> {
	public void setProperty(Widget widget, Integer value){
		doSwitch(widget, value);
	}

	public Object caseCBanner(CBanner widget, Integer value){
		widget.setRightWidth(value);
		return null;
	}
}
