 ...
 */
public class SetDescriptionControlSwitch extends WidgetSwitchWithArgument<Object, Control> {
	public void setProperty(Widget widget, Control value){
		doSwitch(widget, value);
	}

	public Object caseSection(Section widget, Control value){
		widget.setDescriptionControl(value);
		return null;
	}
}
