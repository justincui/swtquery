 ...
 */
public class SetJavascriptEnabledSwitch extends WidgetSwitchWithArgument<Object, Boolean> {
	public void setProperty(Widget widget, Boolean value){
		doSwitch(widget, value);
	}

	public Object caseBrowser(Browser widget, Boolean value){
		widget.setJavascriptEnabled(value);
		return null;
	}
}
