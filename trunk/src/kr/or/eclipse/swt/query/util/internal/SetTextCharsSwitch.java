 ...
 */
public class SetTextCharsSwitch extends WidgetSwitchWithArgument<Object, char[]> {
	public void setProperty(Widget widget, char[] value){
		doSwitch(widget, value);
	}

	public Object caseText(Text widget, char[] value){
		widget.setTextChars(value);
		return null;
	}
}
