 ...
 */
public class GetTitleBarForegroundSwitch extends WidgetSwitch<Color> {
	public Color getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Color caseExpandableComposite(ExpandableComposite widget){
		return widget.getTitleBarForeground();
	}
}
