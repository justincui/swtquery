 ...
 */
public class SetUnderlinedSwitch extends WidgetSwitchWithArgument<Object, Boolean> {
	public void setProperty(Widget widget, Boolean value){
		doSwitch(widget, value);
	}

	public Object caseHyperlink(Hyperlink widget, Boolean value){
		widget.setUnderlined(value);
		return null;
	}
}
