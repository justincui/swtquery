 ...
 */
public class SetBlockSelectionBoundsSwitch extends WidgetSwitchWithArgument<Object, Rectangle> {
	public void setProperty(Widget widget, Rectangle value){
		doSwitch(widget, value);
	}

	public Object caseStyledText(StyledText widget, Rectangle value){
		widget.setBlockSelectionBounds(value);
		return null;
	}
}
