 ...
 */
public class GetGLDataSwitch extends WidgetSwitch<GLData> {
	public GLData getProperty(Widget widget){
		return doSwitch(widget);
	}

	public GLData caseGLCanvas(GLCanvas widget){
		return widget.getGLData();
	}
}
