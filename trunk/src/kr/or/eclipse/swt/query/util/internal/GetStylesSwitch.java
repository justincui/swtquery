 ...
 */
public class GetStylesSwitch extends WidgetSwitch<TextStyle[]> {
	public TextStyle[] getProperty(Widget widget){
		return doSwitch(widget);
	}

	public TextStyle[] caseIME(IME widget){
		return widget.getStyles();
	}
}
