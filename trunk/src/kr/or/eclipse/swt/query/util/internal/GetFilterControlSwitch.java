 ...
 */
public class GetFilterControlSwitch extends WidgetSwitch<Text> {
	public Text getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Text caseFilteredTree(FilteredTree widget){
		return widget.getFilterControl();
	}
}
