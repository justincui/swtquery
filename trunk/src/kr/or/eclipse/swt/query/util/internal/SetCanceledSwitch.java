 ...
 */
public class SetCanceledSwitch extends WidgetSwitchWithArgument<Object, Boolean> {
	public void setProperty(Widget widget, Boolean value){
		doSwitch(widget, value);
	}

	public Object caseProgressMonitorPart(ProgressMonitorPart widget, Boolean value){
		widget.setCanceled(value);
		return null;
	}
}
