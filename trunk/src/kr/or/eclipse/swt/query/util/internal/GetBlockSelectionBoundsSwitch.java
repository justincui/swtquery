 ...
 */
public class GetBlockSelectionBoundsSwitch extends WidgetSwitch<Rectangle> {
	public Rectangle getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Rectangle caseStyledText(StyledText widget){
		return widget.getBlockSelectionBounds();
	}
}
