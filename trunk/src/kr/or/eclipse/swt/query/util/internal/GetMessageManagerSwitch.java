 ...
 */
public class GetMessageManagerSwitch extends WidgetSwitch<IMessageManager> {
	public IMessageManager getProperty(Widget widget){
		return doSwitch(widget);
	}

	public IMessageManager caseScrolledForm(ScrolledForm widget){
		return widget.getMessageManager();
	}
	public IMessageManager caseForm(Form widget){
		return widget.getMessageManager();
	}
}
