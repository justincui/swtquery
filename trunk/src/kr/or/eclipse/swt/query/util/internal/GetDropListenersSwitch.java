 ...
 */
public class GetDropListenersSwitch extends WidgetSwitch<DropTargetListener[]> {
	public DropTargetListener[] getProperty(Widget widget){
		return doSwitch(widget);
	}

	public DropTargetListener[] caseDropTarget(DropTarget widget){
		return widget.getDropListeners();
	}
}
