 ...
 */
public class SetExpandedSwitch extends WidgetSwitchWithArgument<Object, Boolean> {
	public void setProperty(Widget widget, Boolean value){
		doSwitch(widget, value);
	}

	public Object caseToggleHyperlink(ToggleHyperlink widget, Boolean value){
		widget.setExpanded(value);
		return null;
	}
	public Object caseExpandableComposite(ExpandableComposite widget, Boolean value){
		widget.setExpanded(value);
		return null;
	}
}
