 ...
 */
public class GetViewerSwitch extends WidgetSwitch<TreeViewer> {
	public TreeViewer getProperty(Widget widget){
		return doSwitch(widget);
	}

	public TreeViewer caseFilteredTree(FilteredTree widget){
		return widget.getViewer();
	}
}
