 ...
 */
public class GetTextClientSwitch extends WidgetSwitch<Control> {
	public Control getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Control caseExpandableComposite(ExpandableComposite widget){
		return widget.getTextClient();
	}
}
