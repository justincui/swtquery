 ...
 */
public class GetAccessibleSwitch extends WidgetSwitch<Accessible> {
	public Accessible getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Accessible caseFilteredList(FilteredList widget){
		return widget.getAccessible();
	}
	public Accessible caseControl(Control widget){
		return widget.getAccessible();
	}
}
