 ...
 */
public class GetToolBarManagerSwitch extends WidgetSwitch<IToolBarManager> {
	public IToolBarManager getProperty(Widget widget){
		return doSwitch(widget);
	}

	public IToolBarManager caseScrolledForm(ScrolledForm widget){
		return widget.getToolBarManager();
	}
	public IToolBarManager caseForm(Form widget){
		return widget.getToolBarManager();
	}
}
