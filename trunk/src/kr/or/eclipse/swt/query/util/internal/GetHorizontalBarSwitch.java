 ...
 */
public class GetHorizontalBarSwitch extends WidgetSwitch<ScrollBar> {
	public ScrollBar getProperty(Widget widget){
		return doSwitch(widget);
	}

	public ScrollBar caseScrollable(Scrollable widget){
		return widget.getHorizontalBar();
	}
}
