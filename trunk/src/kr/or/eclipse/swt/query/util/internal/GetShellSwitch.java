 ...
 */
public class GetShellSwitch extends WidgetSwitch<Shell> {
	public Shell getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Shell caseShell(Shell widget){
		return widget.getShell();
	}
	public Shell caseCCombo(CCombo widget){
		return widget.getShell();
	}
	public Shell caseControl(Control widget){
		return widget.getShell();
	}
	public Shell caseMenu(Menu widget){
		return widget.getShell();
	}
}
