 ...
 */
public class GetMonitorSwitch extends WidgetSwitch<Monitor> {
	public Monitor getProperty(Widget widget){
		return doSwitch(widget);
	}

	public Monitor caseControl(Control widget){
		return widget.getMonitor();
	}
}
