...
public class SetPropertySwitchGenerator
{
  ...
  protected final String TEXT_4 = NL + "/*" + NL + " * This file was generated by SWT Query SDK." + NL + " * So you should not modify it manually." + NL + " * If you want to customize this code, contact below:" + NL + " *" + NL + " * http://code.google.com/p/swtquery/" + NL + " */" + NL + "public class Set";
  protected final String TEXT_5 = "Switch extends WidgetSwitchWithArgument<Object, ";
  protected final String TEXT_6 = "> {" + NL + "\tpublic void setProperty(Widget widget, ";
  protected final String TEXT_7 = " value){" + NL + "\t\tdoSwitch(widget, value);" + NL + "\t}" + NL;
  protected final String TEXT_8 = NL + "\tpublic Object case";
  protected final String TEXT_9 = "(";
  protected final String TEXT_10 = " widget, ";
  protected final String TEXT_11 = " value){" + NL + "\t\twidget.set";
  protected final String TEXT_12 = "(value);" + NL + "\t\treturn null;" + NL + "\t}";
