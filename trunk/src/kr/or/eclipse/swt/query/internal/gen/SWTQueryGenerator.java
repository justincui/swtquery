...
public class SWTQueryGenerator
{
  ...
  protected final String TEXT_16 = NL + "\t/**" + NL + "\t * Gets a ";
  protected final String TEXT_17 = " property value." + NL + "\t * " + NL + "\t * @return value a ";
